(function() {
  ...
  let scene,  
      ...
      loader.load(
        ...
        function(gltf) {
         // A lot is going to happen here
          ...
          // Set the models initial scale, this is only because we made our scene gigantic
          model.scale.set(7, 7, 7);
          // Move the model down so it's on the floor
          model.position.y = -11;
                 
          scene.add(model);
          
          // Remove the loader once model has loaded
          loaderAnim.remove();

          // Add in animation mixer for the model (a player for animations)
          mixer = new THREE.AnimationMixer(model);

          // Find all animations that are not idle
          let clips = fileAnimations.filter(val => val.name !== 'idle');

          // Add the idle animation
          let idleAnim = THREE.AnimationClip.findByName(fileAnimations, 'idle');
          // Turn them into Three.js animations and clip out the spine and waist
          ...
          // Splice out the Neck and Waist Movment from the animation
          idleAnim.tracks.splice(3, 3);
          idleAnim.tracks.splice(9, 3);

          // Use the clipaction mixer method to hold the animation in a way that three.js can actually use
    ...
    // Event listener for mouse movement that also gets the position of the mouse
    ...
    // Function to move a joint according to mouse location
    ...
    // Get the location of the mouse in degrees 
